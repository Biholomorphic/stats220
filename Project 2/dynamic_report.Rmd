...
This analysis is based on observations of energy drink presence collecected from the University of Auckland and Auckland University of Technology campuses. The data was collected from myself: Marlo Thacker (mtha970) and Johnathen Sewell (jsew317) over the course of several days. The data captures snapshots of individual brands observed at specific times and places.
